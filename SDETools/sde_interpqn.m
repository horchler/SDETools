function xi=sde_interpqn(t,x,nt,eta)
...
%
%   If X is a non-empty M element column vector, then XI is a column vector of
%   length NT*(M-1)+M.
%   
...
%
%   Class support for inputs T, X, NT, ETA:
%       float: double, single
%
